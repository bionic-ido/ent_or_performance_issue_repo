...
func (au *AdminUpdate) AddTeamMemberIDs(ids ...int) *AdminUpdate {
	au.mutation.AddTeamMemberIDs(ids...)
	return au
}

// AddTeamMembers adds the "team_members" edges to the User entity.
func (au *AdminUpdate) AddTeamMembers(u ...*User) *AdminUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return au.AddTeamMemberIDs(ids...)
}

// SetTeamLeaderID sets the "team_leader" edge to the User entity by ID.
func (au *AdminUpdate) SetTeamLeaderID(id int) *AdminUpdate {
	au.mutation.SetTeamLeaderID(id)
	return au
}

// SetNillableTeamLeaderID sets the "team_leader" edge to the User entity by ID if the given value is not nil.
func (au *AdminUpdate) SetNillableTeamLeaderID(id *int) *AdminUpdate {
	if id != nil {
		au = au.SetTeamLeaderID(*id)
	}
	return au
}

// SetTeamLeader sets the "team_leader" edge to the User entity.
func (au *AdminUpdate) SetTeamLeader(u *User) *AdminUpdate {
	return au.SetTeamLeaderID(u.ID)
}
...
func (au *AdminUpdate) ClearTeamMembers() *AdminUpdate {
	au.mutation.ClearTeamMembers()
	return au
}

// RemoveTeamMemberIDs removes the "team_members" edge to User entities by IDs.
func (au *AdminUpdate) RemoveTeamMemberIDs(ids ...int) *AdminUpdate {
	au.mutation.RemoveTeamMemberIDs(ids...)
	return au
}

// RemoveTeamMembers removes "team_members" edges to User entities.
func (au *AdminUpdate) RemoveTeamMembers(u ...*User) *AdminUpdate {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return au.RemoveTeamMemberIDs(ids...)
}

// ClearTeamLeader clears the "team_leader" edge to the User entity.
func (au *AdminUpdate) ClearTeamLeader() *AdminUpdate {
	au.mutation.ClearTeamLeader()
	return au
}
...
func (au *AdminUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if au.mutation.TeamMembersCleared() {
	...
	if nodes := au.mutation.RemovedTeamMembersIDs(); len(nodes) > 0 && !au.mutation.TeamMembersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   admin.TeamMembersTable,
	...
	if nodes := au.mutation.TeamMembersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   admin.TeamMembersTable,
	...
	if au.mutation.TeamLeaderCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
	...
	if nodes := au.mutation.TeamLeaderIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   admin.TeamLeaderTable,
...
// AddTeamMemberIDs adds the "team_members" edge to the User entity by IDs.
func (auo *AdminUpdateOne) AddTeamMemberIDs(ids ...int) *AdminUpdateOne {
	auo.mutation.AddTeamMemberIDs(ids...)
	return auo
}

// AddTeamMembers adds the "team_members" edges to the User entity.
func (auo *AdminUpdateOne) AddTeamMembers(u ...*User) *AdminUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return auo.AddTeamMemberIDs(ids...)
}

// SetTeamLeaderID sets the "team_leader" edge to the User entity by ID.
func (auo *AdminUpdateOne) SetTeamLeaderID(id int) *AdminUpdateOne {
	auo.mutation.SetTeamLeaderID(id)
	return auo
}

// SetNillableTeamLeaderID sets the "team_leader" edge to the User entity by ID if the given value is not nil.
func (auo *AdminUpdateOne) SetNillableTeamLeaderID(id *int) *AdminUpdateOne {
	if id != nil {
		auo = auo.SetTeamLeaderID(*id)
	}
	return auo
}

// SetTeamLeader sets the "team_leader" edge to the User entity.
func (auo *AdminUpdateOne) SetTeamLeader(u *User) *AdminUpdateOne {
	return auo.SetTeamLeaderID(u.ID)
}
...
// ClearTeamMembers clears all "team_members" edges to the User entity.
func (auo *AdminUpdateOne) ClearTeamMembers() *AdminUpdateOne {
	auo.mutation.ClearTeamMembers()
	return auo
}

// RemoveTeamMemberIDs removes the "team_members" edge to User entities by IDs.
func (auo *AdminUpdateOne) RemoveTeamMemberIDs(ids ...int) *AdminUpdateOne {
	auo.mutation.RemoveTeamMemberIDs(ids...)
	return auo
}

// RemoveTeamMembers removes "team_members" edges to User entities.
func (auo *AdminUpdateOne) RemoveTeamMembers(u ...*User) *AdminUpdateOne {
	ids := make([]int, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return auo.RemoveTeamMemberIDs(ids...)
}

// ClearTeamLeader clears the "team_leader" edge to the User entity.
func (auo *AdminUpdateOne) ClearTeamLeader() *AdminUpdateOne {
	auo.mutation.ClearTeamLeader()
	return auo
}
...
func (auo *AdminUpdateOne) sqlSave(ctx context.Context) (_node *Admin, err error) {
	...
	if auo.mutation.TeamMembersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   admin.TeamMembersTable,
	...
	if nodes := auo.mutation.RemovedTeamMembersIDs(); len(nodes) > 0 && !auo.mutation.TeamMembersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   admin.TeamMembersTable,
	...
	if nodes := auo.mutation.TeamMembersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   admin.TeamMembersTable,
	...
	if auo.mutation.TeamLeaderCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   admin.TeamLeaderTable,
	...
	if nodes := auo.mutation.TeamLeaderIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   admin.TeamLeaderTable,
