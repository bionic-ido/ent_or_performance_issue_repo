...
// QueryTeamMembers queries the team_members edge of a Admin.
func (c *AdminClient) QueryTeamMembers(a *Admin) *UserQuery {
...
// QueryTeamLeader queries the team_leader edge of a Admin.
func (c *AdminClient) QueryTeamLeader(a *Admin) *UserQuery {
	query := &UserQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := a.ID
		step := sqlgraph.NewStep(
...
// QueryMemberAdmin queries the member_admin edge of a User.
func (c *UserClient) QueryMemberAdmin(u *User) *AdminQuery {
...
// QueryLeadAdmin queries the lead_admin edge of a User.
func (c *UserClient) QueryLeadAdmin(u *User) *AdminQuery {
	query := &AdminQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
