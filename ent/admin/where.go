...
func HasTeamMembers() predicate.Admin {
	return predicate.Admin(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TeamMembersTable, FieldID),
...
func HasTeamMembersWith(preds ...predicate.User) predicate.Admin {
	return predicate.Admin(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasTeamLeader applies the HasEdge predicate on the "team_leader" edge.
func HasTeamLeader() predicate.Admin {
	return predicate.Admin(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TeamLeaderTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, TeamLeaderTable, TeamLeaderColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasTeamLeaderWith applies the HasEdge predicate on the "team_leader" edge with a given conditions (other predicates).
func HasTeamLeaderWith(preds ...predicate.User) predicate.Admin {
	return predicate.Admin(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TeamLeaderInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, TeamLeaderTable, TeamLeaderColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
